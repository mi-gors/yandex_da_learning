...
[5. Анализ бизнес-показателей в развлекательном приложении ProcrastinatePRO+](https://github.com/mi-gors/yandex_da_learning/tree/bed4505c2605db9660d30b915c3a9ca7852e7748/5.%20%D0%90%D0%BD%D0%B0%D0%BB%D0%B8%D0%B7%20%D0%B1%D0%B8%D0%B7%D0%BD%D0%B5%D1%81-%D0%BF%D0%BE%D0%BA%D0%B0%D0%B7%D0%B0%D1%82%D0%B5%D0%BB%D0%B5%D0%B9) | На основе данных провести анализ причины убытков, расчет метрик (LTV, CAC, ROI) | `Python` `Pandas` `Matplotlib` `Seaborn`  `когортный анализ` `юнит-экономика` `продуктовые метрики` |
